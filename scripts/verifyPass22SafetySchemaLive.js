...
const REQUIRED_TABLES = [
  {
    ...
    columns: "id,target_user_id,provider,status,metadata,created_at",
  },
  {
    table: "monitoring_alert_events",
...
async function main() {
  ...
  console.log(JSON.stringify({
    ok: true,
    migration: "202605250019_studentos_pass22_mfa_billing_alerts.sql",
    shards,
    mutationExpected: false,
    outputMasked: true,
