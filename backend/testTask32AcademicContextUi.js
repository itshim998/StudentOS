...
assert.match(materialMarkup, /academicContextKindLabel/);
assert.match(app, /study_material: "Study material"/);
assert.match(app, /generated_study_material: "Generated study material"/);
