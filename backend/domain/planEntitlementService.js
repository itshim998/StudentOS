...
const PLAN_ENTITLEMENTS = deepFreeze({
  ...
  starter: planDefinition({
    ...
    classroom: {
      oncePerTrial: false,
      cadenceLabel: "Course list setup only",
      courseOnly: true,
...
export function getPublicEntitlementSummary(planKey) {
  ...
  return {
    ...
    classroom: {
      ...
      courseOnly: entitlements.classroom.courseOnly === true,
      courseworkReviewEnabled: entitlements.classroom.courseworkReviewEnabled === true,
      readOnly: true,
    },
    academicContext: {
